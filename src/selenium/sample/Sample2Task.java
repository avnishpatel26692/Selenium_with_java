...
public class Sample2Task {
    ...
    @Test
    public void Sample2Task() throws Exception {//define driver
...
//        System.out.println(driver.findElement(By.name("This is a button")).getAttribute("value"));
//        System.out.println(driver.findElement(By.name("test")).getAttribute("class"));
//        System.out.println(driver.findElement(By.name("heading_2")).getAttribute("id"));
