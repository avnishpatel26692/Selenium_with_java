...
public class Sample5Task {static String libWithDriversLocation = System.getProperty("user.dir") + "\\lib\\";
    WebDriver driver;
    @Before
    ...
    public void confirmationPopUp()
    {
        ...
        alert3.dismiss();
        WebElement msg3 = driver.findElement(By.id("textForAlerts"));
        String expectedValue3 = "You have dared to deny me!!!";
        String actualValue3 = msg3.getText();
        Assert.assertEquals(expectedValue, actualValue);
