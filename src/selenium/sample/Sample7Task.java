...
public class Sample7Task {static String libWithDriversLocation = System.getProperty("user.dir") + "\\lib\\";
    WebDriver driver;
    @Before
    ...
    @Test
    // selectCheckBox - create a “for” loop for element with selector “.w3-check[type='checkbox']”, within loop check that checkbox is not selected, then click on it and check that it is selected, then click again
...
//electRadioButton - create a “for” loop for element with selector “.w3-check[type=‘radio']”, within loop check that checkbox is not selected, then click on it and check that it is selected, then click again/Then via getElements check that “option 2” is not selected, then click on it and check then element with css “".w3-check[value='Option 2'][type=‘radio']“” is selected
    @Test
    ...
    public void selectDate() throws InterruptedException {
        ...
        {
            Thread.sleep(500);
            WebElement nextMonthBtn = driver.findElement(By.xpath("//span[text()='Next']"));
            nextMonthBtn.click();
        }
