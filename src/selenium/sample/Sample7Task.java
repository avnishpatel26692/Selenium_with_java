...
public class Sample7Task {
    ...
    public void verifyFontSize() {
        ...
        String actualFrontSize = element1.getCssValue("font-size");
        Assert.assertEquals("15px", actualFrontSize);
    ...
    public void verifyBackgroundColor() {
        WebElement luckParagraph7 = driver.findElement(By.xpath("//p[text()='lucky paragraph 7']"));
        String actualValue = luckParagraph7.getCssValue("background-color");
    ...
    @Test
    public void verifyGreenParagraph() {
    ...
    @Test
    public void verifyPurpleParagraph() {
    ...
    @Test
    public void verifyBlueParagraph() {
    ...
    @Test
    public void verifyPinkParagraph() {
    ...
    @Test
    public void verifyWhiteParagraph() {
