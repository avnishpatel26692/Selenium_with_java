...
public class Sample7Task {
    ...
    public void selectCheckBox() throws InterruptedException {
        List<WebElement> checkboxes = driver.findElements(By.cssSelector("input[class='w3-check'][value='Option 3'][type='checkbox']"));
            for (WebElement elementName : checkboxes) //Enhanced for loop
            {
                Assert.assertFalse(elementName.isSelected());
                elementName.click();
    ...
    public void selectRadioButton() {
            List<WebElement> radioBtns = driver.findElements(By.cssSelector("input[class='w3-check'][value='Option 2'][type='radio']"));
            for (WebElement radio : radioBtns) {
                Assert.assertFalse(radio.isSelected());
                radio.click();
                Assert.assertTrue(radio.isSelected());
    ...
    public void chooseDateViaTextBox(){
        ...
        dateTextBox.click();
        String number = "12/15/2014";
        dateTextBox.sendKeys(number);
        WebElement submit = driver.findElement(By.xpath("//input[@id='result_button_date']"));
        submit.click();
