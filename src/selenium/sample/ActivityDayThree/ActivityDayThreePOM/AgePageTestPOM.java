...
public class AgePageTestPOM {
    static String libWithDriversLocation = System.getProperty("user.dir") + "\\lib\\";
    WebDriver driver;
    static AgepagePOM agePage;
    static SubbmitAgePagePOM ageSubmittedPage;
    ...
    public void beforeMethod() {
        ...
        agePage = PageFactory.initElements(driver, AgepagePOM.class);
        ageSubmittedPage = PageFactory.initElements(driver, SubbmitAgePagePOM.class);
    }
    ...
    public void scenario6() {
        agePage.enterName("ABC");
        agePage.enterAge("120");
        agePage.clickOnSubmitBtn();
        String actualMessage = ageSubmittedPage.getMessage();
        Assert.assertEquals("Hello, ABC, you are an immortal", actualMessage);
