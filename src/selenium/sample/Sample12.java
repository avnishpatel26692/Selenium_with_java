...
import selenium.PageObject.Age;
import selenium.PageObject.AgeSubbmited;

public class Sample12 {
    static String libWithDriversLocation = System.getProperty("user.dir") + "\\lib\\";
    WebDriver driver;
    static Age agePage;
    static AgeSubbmited ageSubmittedPage;
    ...
    public void beforeMethod()
    {
        ...
        agePage = PageFactory.initElements(driver, Age.class);
        ageSubmittedPage = PageFactory.initElements(driver, AgeSubbmited.class);
    }
    ...
    public void scenario4(){
        ...
        agePage.clickOnSubmitBtn();
        String actualMessage = ageSubmittedPage.getMessage();
        Assert.assertEquals("Hello, ABC, you are a teenager", ageSubmittedPage.getMessage());
    }
@Test
    ...
    agePage.clickOnSubmitBtn();
    String actualMessage = ageSubmittedPage.getMessage();
    Assert.assertEquals("Hello, ABC, you are a kid", ageSubmittedPage.getMessage());
}
