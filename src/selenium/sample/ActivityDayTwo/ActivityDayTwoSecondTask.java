...
public class ActivityDayTwoSecondTask {
    ...
    @Test
    public void selectingCheckboxes2() throws InterruptedException {
        List<WebElement> checkboxes = driver.findElements(By.cssSelector("input[type='checkbox']"));
        WebElement option1 = driver.findElement(By.cssSelector("input[id='vfb-6-0']"));
        WebElement option2 = driver.findElement(By.cssSelector("input[id='vfb-6-1']"));
        WebElement option3 = driver.findElement(By.cssSelector("input[id='vfb-6-2']"));
        WebElement resultButton = driver.findElement(By.cssSelector("button[id='result_button_checkbox']"));
        WebElement message = driver.findElement(By.cssSelector("p[id='result_checkbox']"));
        option1.click();
        option1.click();
        option2.click();
        option2.click();
        option3.click();
        resultButton.click();
        String expectedValue = "You selected value(s): Option 3";
        String actualValue = message.getText();
        Assert.assertEquals("You selected value(s): Option 3", expectedValue, actualValue);
    }
    ...
    public void selectRadioButtons() throws InterruptedException {
        ...
        public void selectDate2 () throws InterruptedException {
            ...
            String result = new SimpleDateFormat("MM/15/yyyy").format(cal.getTime());  // 01/15/2021

            WebElement datePickerTxtBox = driver.findElement(By.xpath("//input[@id='vfb-8']"));
            datePickerTxtBox.sendKeys("01/15/2021");
            datePickerTxtBox.click();
            String actualResults = datePickerTxtBox.getAttribute("value");
            Assert.assertEquals(result, actualResults);
        }
