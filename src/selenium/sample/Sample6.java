...
public class Sample6 {
    ...
    public void findXpath1() {
        WebElement element3 = driver.findElement(By.xpath("//div[@id='nonStandartText']/*[contains(@class,'unbelievable')]"));
    ...
    public void findCSSSelector1(){
        ...
        WebElement element4 = driver.findElement(By.cssSelector("div#test1 > .twoTest"));
