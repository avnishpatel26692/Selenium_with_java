...
public class Sample6 {
    ...
    {
        WebElement element1 = driver.findElement(By.xpath("//div[@id='test3']//p[contains(text(),'Test Text')][1]"));
        System.out.println(element1.getText());

        WebElement element2 = driver.findElement(By.xpath("//div[@id='test3']//p[contains(text(),'Test Text')][2]"));
